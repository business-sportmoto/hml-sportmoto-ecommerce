...
<div class="ia_pagina">
  ...
  <div class="ia_topo">
    <div>
      <h1 class="ia_titulo"><i class="bi bi-collection-play"></i><?= $campanha_id > 0 ? 'Continuar campanha' : 'Nova campanha' ?></h1>
    ...
    <div class="ia_form_linha">
      ...
      <div class="ia_form_grupo">
        ...
        <div class="ia_form_linha_compacta">
          ...
          <button type="button" class="ia_btn" id="ia_c_add_lote"><i class="bi bi-plus-circle"></i> Adicionar</button>
        </div>
  ...
  <div class="ia_cartao">
    ...
    <button type="button" class="ia_btn" id="ia_c_estimar"><i class="bi bi-calculator"></i> Calcular estimativa</button>
    <div id="ia_c_estimativa" style="margin-top:12px"></div>
    <div class="ia_resultado_acoes" style="margin-top:16px">
      <button type="button" class="ia_btn" id="ia_c_rascunho"><i class="bi bi-save"></i> Salvar rascunho</button>
      <button type="button" class="ia_btn ia_btn_primario" id="ia_c_iniciar"><i class="bi bi-rocket-takeoff"></i> Aprovar e gerar</button>
    </div>
  </div>
